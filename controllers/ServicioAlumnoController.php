...
class ServicioAlumnoController extends Controller
{
    ...
    /**
     * Lists all ServicioAlumno models.
     * @return mixed
     */
    ...
    /**
     * Displays a single ServicioAlumno model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new ServicioAlumno model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new ServicioAlumno();
    ...
    /**
     * Updates an existing ServicioAlumno model.
    ...
    /**
     * Deletes an existing ServicioAlumno model.
